...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="upload-berkas-kf.php"><i class="fab fa-digital-ocean"></i> Upload Berkas</a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="upload-berkas-kf.php">Upload Berkas</a></li>
        </ol>
      </section>
 ...
 SCAN KTP PESERTA 1 (format: pdf/jpg) (nama file : NamaPeserta_AsalSekolah.jpg)
  <input type="file" class="btn btn-primary btn-block" name="fileUpload[]" > 
  
FOTO PESERTA 1 (format: jpg) (nama file : NamaPeserta_AsalSekolah.jpg)
  <input type="file" class="btn btn-primary btn-block" name="fileUpload[]" > 
