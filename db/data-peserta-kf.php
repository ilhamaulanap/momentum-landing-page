  ...
  $msg = "";
    ...
    if (isset($_POST['submit'])) {
      include '../controller/conn.php';
          ...
          $sql_e = "SELECT * FROM cbt_user WHERE user_id = '$user_id'";
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="data-peserta-kf.php"><i class="fab fa-digital-ocean"></i> Pengisian Data Peserta</a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li>Kuis FIsika 2019</li>
          <li class="active"><a href="data-peserta-kf.php">Pengisian Data Peserta</a></li>
        </ol>
      </section>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="box box-default">
              ...
              <!-- /.box-header -->
              <div class="box-body">
                <form role="form" method="post" action="data-peserta-kf.php"
								onsubmit="if(document.getElementById('agree').checked) { return true; } else { 
                alert('Anda belum menekan Data yang saya masukkan sudah sesuai'); return false; }">
                  <!-- text input -->
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      name="asal_sekolah" id="asal_sekolah" value="<?php echo isset($_POST['asal_sekolah']) ? $_POST['asal_sekolah'] : '' ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Tulis Disini . . ."
                      name="asal_kota" id="asal_kota" value="<?php echo isset($_POST['asal_kota']) ? $_POST['asal_kota'] : '' ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Tulis Disini . . ."
                      name="nama_pembina" id="nama_pembina" value="<?php echo isset($_POST['nama_pembina']) ? $_POST['nama_pembina'] : '' ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      name="no_tlp_pembina" id="no_tlp_pembina" value="<?php echo isset($_POST['no_tlp_pembina']) ? $_POST['no_tlp_pembina'] : '' ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Tulis Disini . . ."
                      name="nama_1" id="nama_1" value="<?php echo isset($_POST['nama_1']) ? $_POST['nama_1'] : '' ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label>Nomer Telepon</label>
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" data-inputmask='"mask": "9999-9999-9999"' data-mask
                      name="no_tlp_1" id="no_tlp_1" value="<?php echo isset($_POST['no_tlp_1']) ? $_POST['no_tlp_1'] : '' ?>">
                    </div>
                    <!-- /.input group -->
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Tulis Disini . . ."
                      name="id_line_1" id="id_line_1" value="<?php echo isset($_POST['id_line_1']) ? $_POST['id_line_1'] : '' ?>">
                    </div>
                    <!-- /.input group -->
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Tulis Disini . . ."
                      name="nama_2" id="nama_2" value="<?php echo isset($_POST['nama_2']) ? $_POST['nama_2'] : '' ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label>Nomer Telepon</label>
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" data-inputmask='"mask": "9999-9999-9999"' data-mask
                      name="no_tlp_2" id="no_tlp_2" value="<?php echo isset($_POST['no_tlp_2']) ? $_POST['no_tlp_2'] : '' ?>">
                    </div>
                    <!-- /.input group -->
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Tulis Disini . . ."
                      name="id_line_2" id="id_line_2" value="<?php echo isset($_POST['id_line_2']) ? $_POST['id_line_2'] : '' ?>">
                    </div>
                    <!-- /.input group -->
                  </div>
                  <div class="form-group">
                  <label>Tipe Penyisihan</label>
                  <select class="form-control"
                  name="tipe_penyisihan" id="tipe_penyisihan" value="<?php echo isset($_POST['tipe_penyisihan']) ? $_POST['tipe_penyisihan'] : '' ?>">
                ...
                <div class="input-group-prepend">
									<div class="input-group-text">
										<input type="checkbox" aria-label="Checkbox for following text input"
											name="checkbox" value="check" id="agree"> Data yang saya masukkan sudah sesuai (Data yang sudah masuk tidak dapat diganti)
									</div><br>
                </div>
          ...
          <div class="col-md-4">
          <?php if ($r_email != "") { ?> <div class="alert alert-warning" role="alert">
								<?php echo $r_email;?>
            ...
            <div class="box box-default">
              ...
              <div class="box-body">
                <h4>Tempat penyisihan offline Kuis Fisika 2019</h4>
                <ul><span>
                  <li>Surabaya</li>
                  <li>bangkalan</li>
                  <li>kediri</li>
